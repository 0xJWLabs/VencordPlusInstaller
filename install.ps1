$DOWNLOAD_CLI = "https://github.com/0xJWLabs/VencordPlusInstaller/releases/latest/download/VencordInstallerCli.exe"
$DOWNLOAD_GUI = "https://github.com/0xJWLabs/VencordPlusInstaller/releases/latest/download/VencordInstaller.exe"
