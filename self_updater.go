...
func GetInstallerDownloadLink() string {
	switch runtime.GOOS {
	case "windows":
		return "https://github.com/0xJWLabs/VencordPlusInstaller/releases/latest/download/VencordInstaller.exe"
	case "darwin":
		return "https://github.com/0xJWLabs/VencordPlusInstaller/releases/latest/download/VencordInstaller.MacOS.zip"
	default:
		return ""
	}
}
