...
const ReleaseUrl = "https://api.github.com/repos/0xJWLabs/VencordPlus/releases/latest"
const ReleaseUrlFallback = "https://vencord.dev/releases/vencord"
const InstallerReleaseUrl = "https://api.github.com/repos/0xJWLabs/VencordPlusInstaller/releases/latest"
const InstallerReleaseUrlFallback = "https://vencord.dev/releases/installer"

var UserAgent = "VencordPlusInstaller/" + InstallerGitHash + " (https://github.com/0xJWLabs/VencordPlusInstaller)"
